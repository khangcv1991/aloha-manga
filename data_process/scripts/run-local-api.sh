...
# npx serverless  plugin install --name serverless-dynamodb-local --stage dev 

# npx serverless  plugin install --name serverless-dynamodb-seed --stage dev 
# npx serverless  plugin  install --stage dev --name serverless-offline
# # npx serverless  plugin  install--name serverless-esbuild 
# npx serverless  plugin  install --stage dev --name serverless-offline-watcher
# npx serverless  plugin  install --stage dev --name serverless-python-requirements
